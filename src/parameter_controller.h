...
class ParameterController {
    ...
    public:
        ...
        std::string get_parameter_tree_ble() { return data_ble; }
        ...
        void update_parameters() {
            ...
            is_sending_ble = true;//data_ble.value("Sender",0);
            is_sending_gpio = false;//data_gpio.value("Sender",0);
